...
function _start_stream() {
	console.log('_start_stream');
        ...
        port = document.getElementById('widget.cbid.mjpg-streamer.core.port').value

        if (document.getElementById('cbid.mjpg-streamer.core.enable_auth').checked) {
            user = document.getElementById('widget.cbid.mjpg-streamer.core.username').value
            pass = document.getElementById('widget.cbid.mjpg-streamer.core.password').value
            login = user + ":" + pass + "@"
        } else {
            login = ""
        }
